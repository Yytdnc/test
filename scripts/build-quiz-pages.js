...
<body>
  ...
  <script src="js/views.js?v=7"></script>
  <script src="js/tests-data.js?v=7"></script>
  <script src="js/custom-tests.js?v=7"></script>
  <script src="js/tests-registry.js?v=7"></script>
  <script src="js/compare-utils.js?v=7"></script>
  <script src="js/compare-session.js?v=7"></script>
