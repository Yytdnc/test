...
<body>
  ...
  <script src="js/tests-data.js?v=10"></script>
  <script src="js/custom-tests.js?v=10"></script>
  <script src="js/tests-registry.js?v=10"></script>
  <script src="js/compare-utils.js?v=10"></script>
  <script src="js/compare-session.js?v=10"></script>
